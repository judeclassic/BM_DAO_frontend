        ...
        showDropdown ? (
          <Dropdown>
            <MLinks>
              ...
              {  user?.account_type === AccountType.USER && <NavButton onClick={() => setShow(!show)} $isActive={pathname.includes("/dashboard/tasks")}>
                  <div>
                    <DocumentIcon />
                    <span>Tasks</span>
                  </div>
              ...
              }
              {
                show && (
                  <SubNavWrapper>
                    ...
                    <SubNavButton onClick={() => handleRouting("/dashboard/tasks/raiders")}>
                      <div>
                        <Image src="/mapper.svg" alt="" height={50} width={24}/>
                      </div>
              ...
              { user?.account_type === AccountType.USER && <NavButton $isActive={pathname === "/dashboard/academy"}  onClick={() => handleRouting("/dashboard/academy")}>
                  <div>
                    <BookIcon />
                    <span>Academy</span>
                  </div>
              ...
              { user?.account_type === AccountType.USER && <NavButton $isActive={pathname === "/dashboard/referral"}  onClick={() => handleRouting("/dashboard/referral")}>
                  <div>
                    <UsersIcon />
                    <span>Referral</span>
                  </div>
